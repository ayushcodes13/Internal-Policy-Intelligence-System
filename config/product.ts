export const productConfig = {
  name: "CANON",
  mark: "CN",
  tagline: "Policy-governed intelligence for decisions that need proof.",
  description:
    "CANON treats approved policy documents as the source of truth, routing every question through owner scoping, governed retrieval, source-backed generation, and grounding review before it answers.",
